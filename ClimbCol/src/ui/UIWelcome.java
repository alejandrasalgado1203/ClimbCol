...
public class UIWelcome extends JFrame{
    ...
    private ClimbersManager climbersManager;
    private ClimbColManager climbcolManager;
    
    public UIWelcome(ClimbersManager climbersManager, ClimbColManager climbcolManager) throws HeadlessException {
		super();
		this.climbersManager = climbersManager;
